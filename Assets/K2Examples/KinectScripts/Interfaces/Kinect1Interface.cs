...
//			return targetFile.Exists && targetFile.Length == iTargetSize;
	...
	public KinectInterop.SensorData OpenDefaultSensor (KinectInterop.FrameSource dwFlags, float sensorAngle, bool bUseMultiSource)
	{
		...
		FacetrackingManager[] faceManagers = GameObject.FindObjectsByType(typeof(FacetrackingManager), FindObjectsSortMode.None) as FacetrackingManager[];
		...
		SpeechManager[] speechManagers = GameObject.FindObjectsByType(typeof(SpeechManager), FindObjectsSortMode.None) as SpeechManager[];
